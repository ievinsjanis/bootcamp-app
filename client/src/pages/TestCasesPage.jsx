      ...
      <div className="tcp-table-wrap">
        <table className="tcp-table">
          <thead>
            <tr>
              <th>Title</th>
              <th className="th-sort" onClick={() => toggleSort('severity')}>
          ...
          <tbody>
            {loading && <tr><td colSpan={5} className="tcp-empty">Loading...</td></tr>}
            ...
            {!loading && rows.map(tc => (
              <tr key={tc.id}>
                ...
                <td>
                  <span className="badge" style={SEVERITY_STYLES[tc.severity]}>
                    {tc.severity}
                  </span>
                </td>
                ...
                <td className="tc-actions">
                  <button className="btn-icon" onClick={() => openEdit(tc)} title="Edit">
                    <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/>
                      <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/>
                    </svg>
                  </button>
                  <button className="btn-icon btn-del" onClick={() => handleDelete(tc)} title="Delete">✕</button>
                </td>
              </tr>
            ))}
          </tbody>
